...
class AutoCode {
    public static void main(String[] args) {
        ...
        dataSourceConfig
                .setUrl("jdbc:mysql://localhost:3306/water_system?useUnicode=true&serverTimeZone=UTC&characterEncoding=utf8&useSSL=false")
                .setDriverName("com.mysql.cj.jdbc.Driver")
                .setUsername("root")
                .setPassword("mynameis123")
                .setDbType(DbType.MYSQL);

        // 3、包配置
        PackageConfig packageConfig = new PackageConfig();
        packageConfig
                .setParent("com.cjl.watersystem")
                .setEntity("entity")
        ...
        strategyConfig
                ...
                .setInclude("admin","courier","customer","dispenser","order","shop","ticket","water")// 设置要映射的表
